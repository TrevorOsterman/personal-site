...
const Sections: React.FC<Props> = ({
  ...
  return (
    <div className="sections">
      ...
      >
        <p>
          I am currently a senior software engineer at a software consultancy in
          Phoenix, AZ called Synapse Studios.
        </p>
        <p>
          ...
          business by enhancing user experience and optimizing performance in a
          scalable manner. I also assume responsibility for bridging the gap
      ...
      >
        ...
        <div className="section__projects__project">
          ...
          <p>
            ...
            loosely adapting the novel "House of Leaves" by Mark Z. Danielewski
            into an interactive, web-based text adventure in the style of old
            text-adventure games. The project is a work in progress, but you can
            check it out{" "}
            <a
